...
<Highlight color="#222">Módulo del Usuario Corporate </Highlight>
...
{/* 
# Modelo E-R para Sistema de Gestión Escolar
...
8. **Tipo de Usuario**
   - ID (PK)
   - Nombre del Rol (por ejemplo, Estudiante, Docente, Administrador)

## Relaciones

- Matriculado en (Estudiante -> Clase)
- Imparte Clases (Docente -> Clase)
- Asignada a Clases (Materia -> Clase)
- Asociada a Estudiante y Materia (Calificación -> Estudiante, Materia)
- Representa a Estudiantes (Representante Legal -> Estudiante)
- Tipo de Usuario (Usuario -> Tipo de Usuario)
