...
9. **Ayuda:** Muestra un formulario de contácto para que el usuario se contacte con el administrador del sistema por ña via email y la interfaz cuenta un boton que direcciona hacia el manual de usuario de la aplicación.

10. **Salir:** Permite cerrar la sesión actual.
