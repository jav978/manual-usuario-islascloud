...
## Listado de Mcomm
> Este módulo permite  al usuario gestionar el listado de los Mcomm, la información se muestra en una tabla que contiene la siguiente información **Name** nombre del mcomm, tipo
![reportes](../../static/img/dashboard/configuraciones/admin-configuracion-3-1.png "Dashboard configuración")
