...
> Bienvenidos al sistema de Reportería  de Isla cloud.
 ...
 :::info[INFO]
   `La navegación por el menú de los diferentes módulos del sistema y las pantallas (Interfaz), es igual para todos los usuarios` **Solo el usuario Admin y IT tienen acceso a los módulos usuario y configuración**; esto con respecto a la interfaz del usuario.
 :::
...
<Tabs>
  <TabItem value="admin" label="Admin">El usuario **Admin** tiene acceso total y control absoluto sobre el sistema.Capacidad para gestionar usuarios, configuraciones</TabItem>
  <TabItem value="clientmanager" label="Client Manager">El usuario **Client Manager** tiene priviliegios limitados. </TabItem>
  <TabItem value="clientuser" label="Client User">El usuario **Client User** tiene priviliegios limitados.</TabItem>
  <TabItem value="corporatemanager" label="Corporate Manager">Este usuario  tiene El usuario **Corporate Manager** tiene priviliegios limitados.</TabItem>
  <TabItem value="userit" label="Information technology">El usuario **It** tiene acceso total y control absoluto sobre el sistema.Capacidad para gestionar usuarios, configuraciones.</TabItem>
</Tabs>
 :::


### Dashboard Principal - Mapa ![Dashboard](../../static/img/iconos/globe.svg "Dasboard Principal")
![Dashboard](/img/dashboard/admin-user/admin-dashboard/admin-dashboard.png "Dasboard Principal")
...
![dashboard](../../static/img/dashboard/admin-user/admin-dashboard/admin-dashboard-2.png "Dashboard Principal")
> **Lista desplegable para seleccionar el módulo de comunicación**   

---

![dashboard](/img/dashboard/admin-user/admin-dashboard/admin-dashboard-3.png "Dashboard Principal")
:::info
...
![dashboard](/img/dashboard/admin-user/admin-dashboard/admin-dashboard-4.png "Dashboard Principal")
...
![Historico](../../static/img/dashboard/admin-user/historico/admin-historico-1.png "Dashboard historico")
> Interfaz del módulo Gráfico histórico
---
![Historico](../../static/img/dashboard/admin-user/historico/admin-historico-2.png "Dashboard historico")
...
![Historico](../../static/img/dashboard/admin-user/historico/admin-historico-3.png "Dashboard historico")
...
![Alarmas y mensajes](../../static/img/dashboard/admin-user/alarmas-mensajes/admin-alarma-mensaje-1.png "Dashboard Alarmas y mensajes")
...
---
![Alarmas y mensajes](../../static/img/dashboard/admin-user/alarmas-mensajes/admin-alarma-mensaje-2.png "Dashboard Alarmas y mensajes")
...
![Alarmas y mensajes](../../static/img/dashboard/admin-user/alarmas-mensajes/admin-alarma-mensaje-3.png "Dashboard Alarmas y mensajes")
> Interfaz del módulo de exportar alrmas
---

![Alarmas y mensajes](../../static/img/dashboard/admin-user/alarmas-mensajes/admin-alarma-mensaje-6.png "Dashboard Alarmas y mensajes")
...
![Alarmas y mensajes](../../static/img/dashboard/admin-user/alarmas-mensajes/admin-alarma-mensaje-4.png "Dashboard Alarmas y mensajes")
...
---
![Alarmas y mensajes](../../static/img/dashboard/admin-user/alarmas-mensajes/admin-alarma-mensaje-5.png "Dashboard Alarmas y mensajes")
> Elementos principales del módulo exportar data de las alarmas.

---

![Alarmas y mensajes](../../static/img/dashboard/admin-user/alarmas-mensajes/admin-alarma-mensaje-7.png "Dashboard Alarmas y mensajes")
> Elementos principales del módulo exportar data de las alarmas.

---

![Alarmas y mensajes](../../static/img/dashboard/admin-user/alarmas-mensajes/admin-alarma-mensaje-8.png "Dashboard Alarmas y mensajes")
...
![normalización](../../static/img/dashboard/admin-user/normalizacion/admin-normalizacion-1.png "Dashboard Normalización")
> Este módulo comprenderá los siguientes elementos: Ósmosis Inversa, Configuración Masiva e Importación de Pruebas.

---
![normalización](../../static/img/dashboard/admin-user/normalizacion/admin-normalizacion-2.png "Dashboard Normalización")
...
![normalización](../../static/img/dashboard/admin-user/normalizacion/admin-normalizacion-configuracion.png "Dashboard Normalización")

> Listado de procesos OI para ESSTIA_COL


![normalización](../../static/img/dashboard/admin-user/normalizacion/admin-normalizacion-3-1.png "Dashboard Normalización")
...
---
![normalización](../../static/img/dashboard/admin-user/normalizacion/admin-normalizacion-8.png "Dashboard Normalización")
> Formulario Para crear proceso de ósmosis

---
![normalización](../../static/img/dashboard/admin-user/normalizacion/admin-normalizacion-4.png "Dashboard Normalización")
> Como se puede apreciar en la imágen el formulario tiene los siguientes campos de registros Mcomm seleccionado: nombre del sensor, tag, nombre, varios botones en donde se seleccionara los diferentes procesos que se van a registrar, al hacer clic se habilita un siderbar con la inpfrmación del proceso a registrar. ejempño **Permeate Flow** 



## Filtrar Ósmosis
![card](../../static/img/iconos/button-seach.svg "grafico tiempo real")
> Con este botón filtramos El listado del proceso de ósmosis 
...
![normalización](../../static/img/dashboard/admin-user/normalizacion/admin-normalizacion-3-2.png "Dashboard Normalización")
> Listado de procesos OI para ESSTIA_COL
...
![normalización](../../static/img/dashboard/admin-user/normalizacion/admin-normalizacion-5.png "Dashboard Normalización")
> List
---
![normalización](../../static/img/dashboard/admin-user/normalizacion/admin-normalizacion-6.png "Dashboard Normalización")
> List

---
![normalización](../../static/img/dashboard/admin-user/normalizacion/admin-normalizacion-7.png "Dashboard Normalización")
> List

---


![normalización](../../static/img/dashboard/admin-user/normalizacion/admin-normalizacion-9.png "Dashboard Normalización")
> List

---
![normalización](../../static/img/dashboard/admin-user/normalizacion/admin-normalizacion-10.png "Dashboard Normalización")
> List

## Módulo Conexion
![conexion](../../static/img/dashboard/admin-user/conexion/admin-conexion-1.png "Dashboard conexion")
> List
---
![conexion](../../static/img/dashboard/admin-user/conexion/admin-conexion-2.png "Dashboard conexion")
> List
---

## Módulo Reportes
![reportes](../../static/img/dashboard/admin-user/reportes/admin-reportes-1.png "Dashboard reportes")
...
---
![reportes](../../static/img/dashboard/admin-user/reportes/admin-reportes-2.png "Dashboard reportes")
> `Interfaz gráfica del módulo Lista de Reportes`
---
![reportes](../../static/img/dashboard/admin-user/reportes/admin-reportes-4.png "Dashboard reportes")
...
### Crear Reporte
> Este módulo presenta un formulario en donde el usuario podrá crear un nuevo reporte.

![reportes](../../static/img/dashboard/admin-user/reportes/admin-reportes-5.png "Dashboard reportes")

![reportes](../../static/img/dashboard/admin-user/reportes/admin-reportes-6.png "Dashboard reportes")
...
![reportes](../../static/img/dashboard/admin-user/reportes/admin-reportes-7.png "Dashboard reportes")
...
## Configuraciones ![card](../../static/img/iconos/menu-config.svg "tarjeta")
...
## Módulo de Información General del Sistema ![card](../../static/img/iconos/id-card.svg "tarjeta")

> **Este módulo muestra al usuario la información general del sistema**
---
![reportes](../../static/img/dashboard/admin-user/configuraciones/admin-configuracion-2.png "Dashboard configuración")
...
---
![reportes](../../static/img/dashboard/admin-user/configuraciones/admin-configuracion-3.png "Dashboard configuración")
...
![reportes](../../static/img/dashboard/admin-user/configuraciones/admin-configuracion-3-1.png "Dashboard configuración")
...
![reportes](../../static/img/dashboard/admin-user/configuraciones/admin-configuracion-3-2.png "Dashboard configuración")
...
![reportes](../../static/img/dashboard/admin-user/configuraciones/admin-configuracion-4.png "Dashboard configuración")
...
![reportes](../../static/img/dashboard/admin-user/configuraciones/admin-configuracion-4-1.png "Dashboard configuración")
...
![reportes](../../static/img/dashboard/admin-user/configuraciones/admin-configuracion-4-2.png "Dashboard configuración")

---
## Listado de Mcomm
> Este módulo permite  al usuario gestionar el listado de los Mcomm, la información se muestra en la tabla que contiene la siguiente descripción **Name nombre del mcomm, tipo, fecha de creación, status, aciones**

![reportes](../../static/img/dashboard/admin-user/configuraciones/admin-configuracion-4-3.png "Dashboard configuración")
...
![reportes](../../static/img/dashboard/admin-user/configuraciones/admin-configuracion-5.png "Dashboard configuración")
...
![reportes](../../static/img/dashboard/admin-user/configuraciones/admin-configuracion-5-0.png "Dashboard configuración")
...
![reportes](../../static/img/dashboard/admin-user/configuraciones/admin-configuracion-5-0-1.png "Dashboard configuración")
...
![reportes](../../static/img/dashboard/admin-user/configuraciones/admin-configuracion-5-0-2.png "Dashboard configuración")
...
![reportes](../../static/img/dashboard/admin-user/configuraciones/admin-configuracion-5-1.png "Dashboard configuración")

---
## Listado de Mcomm
> Este módulo permite  al usuario gestionar el listado de los Mcomm, la información se muestra en la tabla que contiene la siguiente descripción **Name nombre del mcomm, tipo, fecha de creación, status, aciones**

![reportes](../../static/img/dashboard/admin-user/configuraciones/admin-configuracion-5-2.png "Dashboard configuración")
...
![reportes](../../static/img/dashboard/admin-user/configuraciones/admin-configuracion-5-3.png "Dashboard configuración")
