...
> Bienvenidos al sistema de Reportería  de Isla cloud.
...
> Listado de los sensores que estan transmitiendo información en tiempo real. **`si el usuario selecciona con un clic un sensor de la lista, esta acción hace que se redirecione a la vista del módulo del gráfico de tiempo real, mostrado el comportamiento del sensor en una gráfica`**.
...
> `En la tabla al momento de seleciona con un clic un registro, se abre un cuadro de mensaje con los topicos de los sensores Mcomm`. 
---
...
![reportes](../../static/img/dashboard/admin-user/configuraciones/admin-configuracion-5.png )
> Con este ícono el usuario podra borrar o desabiliatr el registro del usuario que seleccione.
