...
# Admin 
<Highlight color="#666">Módulo del usuario Admin </Highlight>


## Usuario Administrador
> Bienvenidos a la página del usuario administrador.
...
---
![reportes](../../static/img/dashboard/reportes/admin-reportes-2.png "Dashboard reportes")
> `Interfaz gráfica del módulo Lista de Reportes`
---
![reportes](../../static/img/dashboard/reportes/admin-reportes-4.png "Dashboard reportes")
...
![reportes](../../static/img/dashboard/reportes/admin-reportes-5.png "Dashboard reportes")

![reportes](../../static/img/dashboard/reportes/admin-reportes-6.png "Dashboard reportes")
...
![reportes](../../static/img/dashboard/reportes/admin-reportes-7.png "Dashboard reportes")
...
---
![configuraciones](../../static/img/dashboard/configuraciones/admin-configuracion-1.png)
...
---
![reportes](../../static/img/dashboard/configuraciones/admin-configuracion-2.png "Dashboard configuración")
...
---
![reportes](../../static/img/dashboard/configuraciones/admin-configuracion-3.png "Dashboard configuración")
...
![reportes](../../static/img/dashboard/configuraciones/admin-configuracion-3-1.png "Dashboard configuración")
...
![reportes](../../static/img/dashboard/configuraciones/admin-configuracion-3-2.png "Dashboard configuración")
...
![reportes](../../static/img/dashboard/configuraciones/admin-configuracion-4.png "Dashboard configuración")
...
![reportes](../../static/img/dashboard/configuraciones/admin-configuracion-4-1.png "Dashboard configuración")
...
![reportes](../../static/img/dashboard/configuraciones/admin-configuracion-4-2.png "Dashboard configuración")

---
## Listado de Mcomm
> Este módulo permite  al usuario gestionar el listado de los Mcomm, la información se muestra en la tabla que contiene la siguiente descripción **Name nombre del mcomm, tipo, fecha de creación, status, aciones**

![reportes](../../static/img/dashboard/configuraciones/admin-configuracion-4-3.png "Dashboard configuración")
...
![reportes](../../static/img/dashboard/configuraciones/admin-configuracion-5.png "Dashboard configuración")
...
![reportes](../../static/img/dashboard/configuraciones/admin-configuracion-5-0.png "Dashboard configuración")
...
![reportes](../../static/img/dashboard/configuraciones/admin-configuracion-5-0-1.png "Dashboard configuración")
...
![reportes](../../static/img/dashboard/configuraciones/admin-configuracion-5-0-2.png "Dashboard configuración")
...
![reportes](../../static/img/dashboard/configuraciones/admin-configuracion-5-1.png "Dashboard configuración")

---
## Listado de Mcomm
> Este módulo permite  al usuario gestionar el listado de los Mcomm, la información se muestra en la tabla que contiene la siguiente descripción **Name nombre del mcomm, tipo, fecha de creación, status, aciones**

![reportes](../../static/img/dashboard/configuraciones/admin-configuracion-5-2.png "Dashboard configuración")
...
![reportes](../../static/img/dashboard/configuraciones/admin-configuracion-5-3.png "Dashboard configuración")
